...
public partial class Sugar_BussinessRelated_PgeDoInformationUtility : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string GetCustomers(string searchTerm, int pageIndex, string Trantype, string Trantype1, string Trantype2, string Trantype3, int PageSize, int Company_Code, int year)
    {
        string searchtxt = "";
        string delimStr = "";
