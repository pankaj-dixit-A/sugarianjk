        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                ...
                data: '{searchTerm: "' + SearchTerm() + '", pageIndex: "' + pageIndex + '",Trantype: "' + $("#<%=drpTrnType.ClientID %>").val() + '",Trantype1: "'
                    + $("#<%=drpMailSend.ClientID %>").val() + '",Trantype2: "' + $("#<%=drpEinvoice.ClientID %>").val()
                    + '",Trantype3: "' + $("#<%=drpPayment.ClientID %>").val() + '",PageSize: "' + $("#<%=drpPagesize.ClientID %>").val() + '",Company_Code: "' +
                    '<%= Session["Company_Code"] %>' + '",year: "' + '<%= Session["year"] %>' + '"}',
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; 
            <asp:Label ID="Label6" runat="server" Text="Payment Received" Font-Bold="True" ForeColor="#CC3300"
                Font-Size="Medium"></asp:Label>
            <asp:DropDownList ID="drpPayment" runat="server" CssClass="ddl" Width="70px" Height="24px"
                AutoPostBack="false" onchange="functionToTriggerClick();">
                <asp:ListItem Text="No" Value="N"></asp:ListItem>
                <asp:ListItem Text="Yes" Value="Y"></asp:ListItem>
            </asp:DropDownList>
