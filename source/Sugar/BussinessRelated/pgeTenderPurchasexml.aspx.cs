    ...
    protected void txtitem_code_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtitem_code.Text != string.Empty)
            {
                ...
                {
                    DataSet ds = clsDAL.SimpleQuery("select System_Name_E,Gst_Code,gstratre,systemid,HSN from qrymstitem where System_Type='I' and System_Code=" + txtitem_code.Text + " and Company_Code=" + Session["Company_Code"].ToString() + " ");
