...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function sp1(fromDT, toDT, Branch_Code) {
            var tn;
            window.open('../Report/rptNewDispatchRegisterPrint.aspx?fromDT=' + fromDT + '&toDT=' + toDT + '&Branch_Code=' + Branch_Code, '_blank');    //R=Redirected  O=Original
        }
                ...
                <table width="100%" style="margin-left: 60px;" align="left" cellpadding="5" cellspacing="6">
                    <tr>
                        <td align="left">
                            ...
                            &nbsp;
                              <asp:Button ID="btnDispRegisterPrint" runat="server" Text="Desp Register Print" CssClass="btnHelp"
                                Width="160px" OnClick="btnDispRegisterPrint_Click" Height="24px" />
                            &nbsp;
