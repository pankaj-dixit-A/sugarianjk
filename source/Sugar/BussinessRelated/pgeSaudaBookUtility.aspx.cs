       ...
       // int CompanyStateCode = Convert.ToInt32(Session["CompanyGSTStateCode"].ToString());
        ...
        if (btnUpdate.Text == "Update")
        {
            ...
            TenderQuntl = Convert.ToDouble(clsCommon.getString("SELECT Buyer_Quantal from nt_1_tenderdetails where tenderdetailid=" 
                + tenderdetailid + " and Company_Code='" + Session["Company_Code"].ToString() + "' and Year_Code=" + Convert.ToInt32(Session["year"]).ToString()));
        ...
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "api-call", "javascript:Confirm1('" + myMoblie_Number + "','" + Wamessage + "','" + massage + "');", true);
