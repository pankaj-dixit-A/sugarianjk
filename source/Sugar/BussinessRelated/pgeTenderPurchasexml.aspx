...
function SelectRow(CurrentRow, RowIndex) {
    ...
    "'  TDSAmount='" + LV_TDSAmt + "'  TDS='" + tds + "' ta='" + pt + "' HSN='" + hsnnumber + "'></Commission>";
      ...
      "' Voucher_Type='" + voucher_type + "' commissionid='" + commisionid + "' Party_Bill_Rate='" + party_Bill_rate +
      "' TDS_Rate='" + TDS_Rate + "' TDS_Amt='" + TDS_Amt + "' Temptender='" + Temptender + "'  AutoPurchaseBill='" + Autopurchase + "' Unit='" + Unit + "'>";
            //Detail Calculation
