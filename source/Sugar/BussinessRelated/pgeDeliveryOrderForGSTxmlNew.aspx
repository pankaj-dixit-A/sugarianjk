...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function odethanol(do_no, mill, PO, a, tenderno, bss, Paymentto) {
            var tn;
            window.open('../Report/rptDeliveryOrderForGSTEthanol.aspx?do_no=' + do_no + '&mill=' + mill + '&PO=' + PO
                + '&a=' + a + '&tenderno=' + tenderno + '&bss=' + bss + '&Paymentto=' + Paymentto);    //R=Redirected  O=Original
        }
...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        function DeleteConform() {
            ...
            if (Outword_Date == "" || Outword_Date == 0) {
            ...
            //   DocDates = DocDates.slice(6, 11) + "/" + DocDates.slice(3, 5) + "/" + DocDates.slice(0, 2);
        ...
        function pagevalidation() {
            ...
            try {
                ...
                var PaymentShort = 0, GSTRate = 0, cgstrate = 0, sgstrate = 0, igstrate = 0, PDS = 0,
                    PaymentGst = 0, PaymentTo = 0,
                ...
                var PurchaseTDSamtDO = parseFloat($("#<%=txtpurchaseTDSamt.ClientID %>").val() == "" ? 0 : $("#<%=txtpurchaseTDSamt.ClientID %>").val());
                var PurchaseTCSamtDO = parseFloat($("#<%=txtpurchaseTCSamt.ClientID %>").val() == "" ? 0 : $("#<%=txtpurchaseTCSamt.ClientID %>").val());
                var PurchaseCGSTamtDO = parseFloat($("#<%=txtpurchaseCGSTamt.ClientID %>").val() == "" ? 0 : $("#<%=txtpurchaseCGSTamt.ClientID %>").val());
                var PurchaseSGSTamtDO = parseFloat($("#<%=txtpurchaseSGSTamt.ClientID %>").val() == "" ? 0 : $("#<%=txtpurchaseSGSTamt.ClientID %>").val());
                var PurchaseIGSTamtDO = parseFloat($("#<%=txtpurchaseIGSTamt.ClientID %>").val() == "" ? 0 : $("#<%=txtpurchaseIGSTamt.ClientID %>").val());
                var PurchaseOtheramtDO = parseFloat($("#<%=txtpurchaseOtheramt.ClientID %>").val() == "" ? 0 : $("#<%=txtpurchaseOtheramt.ClientID %>").val());
                ...
                //}
                var Unit_Type = $("#<%=drpUnittype.ClientID %>").val();
            ...
            var bb = document.getElementById("<%= hdnfsupplieshortname.ClientID %>").value;
                ...
                var GSTNarrationSB = document.getElementById("<%= hdnfmillshortname.ClientID %>").value + " " + txtquantal + "L:"
                                                            + TRUCK_NO + "DO:" + doDoc_No + "F:" + MEMO_ADVANCE
                                                            + "BuyerName:" + bb;
                var TDSNarrationSB = document.getElementById("<%= hdnfmillshortname.ClientID %>").value + " " + txtquantal + "L:"
                                                           + TRUCK_NO + "DO:" + doDoc_No + "F:" + MEMO_ADVANCE
                                                           + "BuyerName:" + document.getElementById("<%=hdnfsalebilltoshortname.ClientID%>").value;
                ...
                if (DESP_TYPE == "DI" && (txtGETPASS_CODE == SELFAC || PDS == "P")) {
                    if (autopurchasebill == "Y") {
                        ...
                        if (CompanyStateCode == PaymentGst) {
                            ...
                            //PS_SGSTAmount = Math.round(parseF11loat(PS_amount * sgstrate / 100));
                            PS_CGSTAmount = Math.round(parseFloat(PurchaseCGSTamtDO));
                            PS_SGSTAmount = Math.round(parseFloat(PurchaseSGSTamtDO));
                            PS_IGSTAmount = 0;
                            igstrate = 0;
                        }
                        else {
                            ...
                            PS_SGSTAmount = 0;
                            sgstrate = 0;
                            PS_IGSTAmount = Math.round(parseFloat(PurchaseIGSTamtDO));
                        }
                        TOTALPurchase_Amount = Math.round(parseFloat(PS_amount + PS_CGSTAmount + PS_SGSTAmount + PS_IGSTAmount + PurchaseOtheramtDO));

                        var TCS_Amt = Math.round((parseFloat(PurchaseTCSamtDO)));
                        var TDS_Amt = Math.round((parseFloat(PurchaseTDSamtDO)));
                        ...
                        if (voucherlbl == "" || voucherlbl == "0") {
                            XML = XML + "<PurchaseHead doc_no='" + purcDoc_No + "' Tran_Type='PS' PURCNO='" + doDoc_No + "' doc_date='" + PUR_DATE + "' " +
                                                    ...
                                                    "bank_commission='0' OTHER_AMT='" + PurchaseOtheramtDO + "' Bill_Amount='" + TOTALPurchase_Amount + "' Due_Days='1' " +
                                                   ...
                                                   "' TCS_Amt='" + TCS_Amt + "' TCS_Net_Payable='" + NetPayble + "' TDS_Rate='" + PurchaseTDSrate +
                                                   "' TDS_Amt='" + TDS_Amt + "' Unit='" + Unit_Type + "'>" +
                            ...
                            XML = XML + "<PurchaseHead doc_no='" + purcDoc_No + "' Tran_Type='PS' PURCNO='" + doDoc_No + "' doc_date='" + PUR_DATE + "' " +
                             ...
                             "Modified_By='" + USER + "' Bill_No='" + MillInvoiceno + "' EWay_Bill_No='" + MillEwayBill + "' purchaseid='" + purcid + "' ac='" + PaymentId + "' uc='" + PS_uc + "' " +
                             "mc='" + mc + "' bk='" + bk + "' mill_inv_date='" + MillInv_Date + "' grade='" + txtGRADE + "' " +
                            "Purcid='" + doid + "' SelfBal='" + PS_SelfBal + "' TCS_Rate='" + TCS_Rate + "' TCS_Amt='" + TCS_Amt +
                            "' TCS_Net_Payable='" + NetPayble + "' TDS_Rate='" + PurchaseTDSrate + "' TDS_Amt='" + TDS_Amt + "' Unit='" + Unit_Type + "'>" +
                            "<PurchaseDetail doc_no='" + purcDoc_No + "' detail_id='1' Tran_Type='PS' item_code='" + txtitem_Code + "' narration='' Quantal='" + txtquantal + "' packing='" + PACKING + "' bags='" + BAGS + "' " +
                             "rate='" + Purchase_Rate + "' item_Amount='" + PS_amount + "' Company_Code='" + Company_Code + "' Year_Code='" + Year_Code + "' " +
                        ...
                        if (PurchaseOtheramtDO != 0) {
                            if (PurchaseOtheramtDO > 0) {
                                Order_Code = Order_Code + 1;

                                XML = XML + "<Ledger TRAN_TYPE='PS' CASHCREDIT='' DOC_NO='" + purcDoc_No + "' DOC_DATE='" + PUR_DATE + "' AC_CODE='" + <%=Session["OTHER_Ac"] %> + "' " +
                                  "UNIT_code='0' NARRATION='Other Amt' AMOUNT='" + Math.abs(PurchaseOtheramtDO) + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                  "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                  "SORT_TYPE='PS' SORT_NO='" + purcDoc_No + "' ac='" + <%=Session["OTHER_Acid"] %> + "' vc='0' progid='5' tranid='0'/>";
                            }
                            else {
                                Order_Code = Order_Code + 1;
    ...
    "'  TDSAmount='" + LV_TDSAmt + "'  TDS='" + LV_TDSRate + "' ta='" + CommTDSAc_ID + "' HSN='" + hsnnumber + "'/>";
                        ...
                        if (LV_TDSAmt != 0) {
                            if (voucher_type == "LV") {
                                ...
                                XML = XML + "<Ledger TRAN_TYPE='" + voucher_type + "' CASHCREDIT='' DOC_NO='" + commiDoc_No + "' DOC_DATE='" + DOC_DATE + "' AC_CODE='" + SaleBillTo + "' " +
                                      "UNIT_code='0' NARRATION='TDS' AMOUNT='" + LV_TDSAmt + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                      "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='C' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                      "SORT_TYPE='" + voucher_type + "' SORT_NO='" + commiDoc_No + "' ac='" + sb + "' vc='0' progid='11' tranid='0'/>";
                                Order_Code = parseInt(Order_Code) + 1;
                ...
                if (DESP_TYPE != "DO" && txtSaleBillTo != "0" && txtSaleBillTo != SELFAC && txtSaleBillTo != "2") {
                    if (SbNo == "" || SbNo == "0") {
                        ...
                        XML = XML + "<SaleHead doc_no='" + saleDoc_No + "' Tran_Type='SB' PURCNO='" + purcDoc_No + "' Purcid='" + purcid + "' doc_date='" + DOC_DATE +
                            ...
                            "' EwayBillValidDate='" + DOC_DATE + "' IsDeleted='1' TDS_Rate='" + SaleTDSrate + "' TDS_Amt='" + TDSAmt + "' SBNarration='" + SBNARRATION + "' Unit='" + Unit + "'>" +
                        ...
                        XML = XML + "<SaleHead doc_no='" + saleDoc_No + "' Tran_Type='SB' PURCNO='" + purcDoc_No + "' Purcid='" + purcid + "' doc_date='" + DOC_DATE + "' Ac_Code ='" + SB_Ac_Code + "' " +
                            ...
                            + "' bt='" + sbbt + "' EwayBillValidDate='" + EwayBill_ValidDate + "' IsDeleted='1' TDS_Rate='" + SaleTDSrate + "' TDS_Amt='" + TDSAmt + "' SBNarration='" + SBNARRATION + "' Unit='" + Unit + "'>" +
                            "<SaleDetail doc_no='" + saleDoc_No + "' detail_id='1' Tran_Type='SB' item_code='" + txtitem_Code + "' narration='' Quantal='" + txtquantal + "' packing='" + PACKING + "'  " +
                            "bags='" + BAGS + "' rate='" + SaleDetail_Rate + "'  " +
                    ...
                    if (TDSAmt > 0) {
                        ...
                        XML = XML + "<Ledger TRAN_TYPE='SB' CASHCREDIT='' DOC_NO='" + purcDoc_No + "' DOC_DATE='" + DOC_DATE + "' AC_CODE='" + <%=Session["SaleTDSAc"] %> + "' " +
                          "UNIT_code='0' NARRATION='" + 'TDS:' + TDSNarrationSB + "' AMOUNT='" + TDSAmt + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                          "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                ...
                if (RecordStatus == "Save") {
                  ...
                  "SalebilltoGstStateCode='" + txtSalebilltoGstStateCode + "' GstAmtOnMR='0.00' GstAmtOnSR='0.00' GstExlSR='0.00' GstExlMR='0.00' " +
                   ...
                   "va='" + va + "' carporate_ac='" + BillTo + "' ca='" + bt + "' mill_inv_date='" + MillInv_Date + "' mill_rcv='" + Inv_Chk + "' saleid='" + saleid + "' MillEwayBill='" + MillEwayBill + "' " +
                    ...
                    "' PurchaseRate='" + Purchase_Rate + "' SBNarration='" + SBNARRATION + "' Do_DATE='" + Do_DATE + "' UnitType='" + Unit_Type + "' PurchaseTCSamt='" + PurchaseTCSamtDO +
                    "' PurchaseTDSamt='" + PurchaseTDSamtDO + "' PurchaseCSGTamt='" + PurchaseCGSTamtDO + "' PurchaseSGSTamt='" + PurchaseSGSTamtDO +
                    "' PurchaseIGSTamt='" + PurchaseIGSTamtDO + "' PurchaseOtheramt='" + PurchaseOtheramtDO + "'>";
                   ...
                   "SalebilltoGstStateCode='" + txtSalebilltoGstStateCode + "' GstAmtOnMR='0.00' GstAmtOnSR='0.00' GstExlSR='0.00' GstExlMR='0.00' " +
                    ...
                    "' SBNarration='" + SBNARRATION + "' Do_DATE='" + Do_DATE + "' UnitType='" + Unit_Type + "' PurchaseTCSamt='" + PurchaseTCSamtDO +
                    "' PurchaseTDSamt='" + PurchaseTDSamtDO + "' PurchaseCSGTamt='" + PurchaseCGSTamtDO + "' PurchaseSGSTamt='" + PurchaseSGSTamtDO +
                    "' PurchaseIGSTamt='" + PurchaseIGSTamtDO + "' PurchaseOtheramt='" + PurchaseOtheramtDO + "'>";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (
                        ...
                        var partysms = " Truck is sent for loading. " + "\r\n" + "" + "\r\n" + "" +
                                      " DO NO: " + dono + "" + "\r\n" + "" +
                                      " DATE: " + date + "" + "\r\n" + "" +
                                      " QUNTIL: " + qntl + "" + "\r\n" + "" +
                                      " Sale Bill No:" + SB_No + "";
                        ...
                        var millsms = "DO NO: " + dono + "" + "\r\n" + "" +
                                    " Date:" + date + "" + "\r\n" + "" +
                                   " Getpass:" + getpassname + "" + "\r\n" + "" +
                                   " SHIPPED TO: " + Shipped_ToName + "" + "\r\n" + "" +
                                    " SHIPPED ADDRESS: " + shippedTo_Address + "" + "\r\n" + "" +
                                   " SHIPPED TO CITY: " + shippedTo_City_Name + "" + "\r\n" + "" +
                                    " SHIPPED TO STATE: " + ShippedtTo_City_State + "" + "\r\n" + "" + 
                                   " QUNTIL: " + qntl + "" + "\r\n" + "";
                        ...
                        //var transportsms = " The truck is confirm load. " + "\r\n" + 
                        // " DO:" + dono + "" + "\r\n" + "" + 
                        // "Date:" + date + "" + "\r\n" + "" + 
                        //"" + millshort + " Getpass:" + getpassname + " Shipped To:"
                    ...
                    <table cellspacing="5" align="left">
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="4" style="width: 10%;">
                                ...
                                &nbsp;
                                 Unit Type:
                                <asp:DropDownList ID="drpUnittype" runat="server" CssClass="ddl" Width="100px"
                                    TabIndex="7" Enabled="true" AutoPostBack="false" Height="26px" OnSelectedIndexChanged="drpUnittype_SelectedIndexChanged">

                                    <asp:ListItem Text="QUINTAL" Value="QTL"></asp:ListItem>
                                    <asp:ListItem Text="LITRE" Value="LTR"></asp:ListItem>
                                    <asp:ListItem Text="METRIC TON" Value="MTS"></asp:ListItem>
                                </asp:DropDownList>
                                &nbsp;
                                  Brand_Code
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="4" style="width: 10%;">
                                ...
                                &nbsp;&nbsp;<asp:Label runat="server" ID="lblVoucherLedgerByBalance" ForeColor="Yellow"
                                    Text=""></asp:Label>
                                <asp:Label runat="server" ID="lblvoucherbyGSTNo" CssClass="lblName"
                                    Text=""></asp:Label>
                                &nbsp;State Code:
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="4" style="width: 10%;">
                                ...
                                &nbsp; &nbsp;<asp:Label runat="server" ID="lblSaleBillToLedgerByBalance" ForeColor="Yellow"
                                    Text=""></asp:Label>
                                <asp:Label ID="lblSaleBillToGSTNo" runat="server" CssClass="lblName"></asp:Label>
                                &nbsp; State Code:
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 20%; border-bottom: 3px solid white;" colspan="6">
                                <asp:TextBox ID="txtTruck_NO" runat="Server" CssClass="txt" TabIndex="35" Width="140px"
                                ...
                                <asp:TextBox runat="server" ID="txtDriverMobile" CssClass="txt" TabIndex="36" Width="140px"
                        ...
                        <tr>
                            ...
                            <td colspan="4" align="left">
                                <asp:Button ID="btnCustomizeDO" runat="server" Text="Cistomize DO" CssClass="btnHelp" Width="70px"
                                    Height="24px" OnClick="btnCustomizeDO_Click" OnClientClick="Confirm13()" Visible="false" />
                                ...
                                <asp:Button ID="btnOurdoEthanol" runat="server" Text="Our DO for ethanol" CssClass="btnHelp" Width="70px"
                                    Height="24px" OnClick="btnOurdoEthanol_Click" OnClientClick="Confirmethanol()" />
                                ...
                                TCSAmt<asp:TextBox ID="txtpurchaseTCSamt" runat="Server" CssClass="txt" Width="120px" Style="text-align: left;"
                                    TabIndex="0" AutoPostBack="false"
                                    Height="24px"></asp:TextBox>
                                TDSAmt<asp:TextBox ID="txtpurchaseTDSamt" runat="Server" CssClass="txt" Width="120px" Style="text-align: left;"
                                    TabIndex="0" AutoPostBack="false"
                                    Height="24px"></asp:TextBox>
                                CGSTamt 
                                <asp:TextBox ID="txtpurchaseCGSTamt" runat="Server" CssClass="txt" Width="120px" Style="text-align: left;"
                                    TabIndex="0" AutoPostBack="false"
                                    Height="24px"></asp:TextBox>
                                SGSTamt 
                                <asp:TextBox ID="txtpurchaseSGSTamt" runat="Server" CssClass="txt" Width="120px" Style="text-align: left;"
                                    TabIndex="0" AutoPostBack="false"
                                    Height="24px"></asp:TextBox>
                                IGSTamt
                                <asp:TextBox ID="txtpurchaseIGSTamt" runat="Server" CssClass="txt" Width="120px" Style="text-align: left;"
                                    TabIndex="0" AutoPostBack="false"
                                    Height="24px"></asp:TextBox>
                                Other +-
                                <asp:TextBox ID="txtpurchaseOtheramt" runat="Server" CssClass="txt" Width="120px" Style="text-align: left;"
                                    TabIndex="0" AutoPostBack="false"
                                    Height="24px"></asp:TextBox>
                            </td>
                        </tr>
