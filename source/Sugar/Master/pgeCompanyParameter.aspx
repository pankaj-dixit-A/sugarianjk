<%@ Page Title="Company Parameter" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table width="100%" align="left" cellspacing="3px">
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Mill Payment Date:
                        </td>
                        ...
                        <td align="right" style="width: 20%;">Dispatch Type:
                        </td>
                        <td>
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Commission A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <td align="right" style="width: 20%;">Interest A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Transport A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <td align="right" style="width: 20%;">Postage A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Self A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <td align="right" style="width: 20%;">GST State Code:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Sale CGST A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <td align="right" style="width: 20%;">Sale SGST A/c:
                            </td>
                            <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Sale IGST A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <td align="right" style="width: 20%;">Purchase CGST A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Purchase SGST A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <td align="right" style="width: 20%;">Purchase IGST A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Transport RCM GSTRate:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <td align="right" style="width: 20%;">CGST RCM Ac:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">SGST RCM Ac:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <td align="right" style="width: 20%;">IGST RCM Ac:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Autogenearte Voucher:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:CheckBox runat="server" ID="chkAutoVoucher" Height="10px" TabIndex="19" Width="10px" />
                        </td>

                        <td align="right" style="width: 20%;">Round off:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Freight A/C:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <td align="right" style="width: 20%;">TCS %:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtTCS" runat="Server" CssClass="txt" TabIndex="22" Width="80px"
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Purchase TCS A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtPurchaseTCSAc" runat="Server" CssClass="txt" TabIndex="23" Width="80px"
                                OnkeyDown="tcsp(event);" Height="24px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtPurchaseTCSAc_TextChanged"></asp:TextBox>
                        ...
                        <td align="right" style="width: 20%;">Sale TCS A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtSaleTCSAc" runat="Server" CssClass="txt" TabIndex="24" Width="80px"
                                OnkeyDown="tcssale(event);" Height="24px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtSaleTCSAc_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Other A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtother_amount_ac" runat="Server" CssClass="txt" TabIndex="25"
                                    Height="24px" Width="80px" Style="text-align: right;" OnkeyDown="otheramt(event);" AutoPostBack="false" OnTextChanged="txtother_amount_ac_TextChanged"></asp:TextBox>
                        ...
                        <td align="right" style="width: 20%;">Market Sase A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtMarketSase" runat="Server" CssClass="txt" TabIndex="26" Width="80px"
                                    Height="24px" Style="text-align: right;" OnkeyDown="marketsase(event);" AutoPostBack="false" OnTextChanged="txtMarketSase_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Supercost A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtSupercost" runat="Server" CssClass="txt" TabIndex="27" Width="80px"
                                    Height="24px" Style="text-align: right;" OnkeyDown="supercost(event);" AutoPostBack="false" OnTextChanged="txtSupercost_TextChanged"></asp:TextBox>
                        ...
                        <td align="right" style="width: 20%;">Packing A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtPacking" runat="Server" CssClass="txt" TabIndex="28" Width="80px"
                                    Height="24px" Style="text-align: right;" OnkeyDown="packing(event);" AutoPostBack="false" OnTextChanged="txtPacking_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Hamali A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txthamali" runat="Server" CssClass="txt" TabIndex="29" Height="24px"
                                    Width="80px" Style="text-align: right;" OnkeyDown="hamali(event);" AutoPostBack="false" OnTextChanged="txthamali_TextChanged"></asp:TextBox>
                        ...
                        <td align="right" style="width: 20%;">Transport TDS A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txttransportTDS" runat="Server" CssClass="txt" TabIndex="30" Height="24px"
                                    Width="80px" Style="text-align: right;" OnkeyDown="transTDS(event);" AutoPostBack="false" OnTextChanged="txttransportTDS_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Transport TDS Cut by Us A/c:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txttransportTDSCut" runat="Server" CssClass="txt" TabIndex="31" Height="24px"
                                    Width="80px" Style="text-align: right;" OnkeyDown="transTDSCut(event);" AutoPostBack="false" OnTextChanged="txttransportTDSCut_TextChanged"></asp:TextBox>
                        ...
                        <td align="right" style="width: 20%;">Return Sale CGST:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtReturnSaleCGST" runat="Server" CssClass="txt" TabIndex="32" Height="24px"
                                    Width="80px" Style="text-align: right;" OnkeyDown="ReturnSaleCGST(event);" AutoPostBack="false" OnTextChanged="txtReturnSaleCGST_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Return Sale SGST:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtReturnSaleSGST" runat="Server" CssClass="txt" TabIndex="33" Height="24px"
                                    Width="80px" Style="text-align: right;" OnkeyDown="ReturnSaleSGST(event);" AutoPostBack="false" OnTextChanged="txtReturnSaleSGST_TextChanged"></asp:TextBox>
                        ...
                        <td align="right" style="width: 20%;">Return Sale IGST:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtReturnSaleIGST" runat="Server" CssClass="txt" TabIndex="34" Height="24px"
                                    Width="80px" Style="text-align: right;" OnkeyDown="ReturnSaleIGST(event);" AutoPostBack="false" OnTextChanged="txtReturnSaleIGST_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Return Purchase CGST:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtReturnPurchaseCGST" runat="Server" CssClass="txt" TabIndex="35" Height="24px"
                                    Width="80px" Style="text-align: right;" OnkeyDown="ReturnPurchaseCGST(event);" AutoPostBack="false" OnTextChanged="txtReturnPurchaseCGST_TextChanged"></asp:TextBox>
                        ...
                        <td align="right" style="width: 20%;">Return Purchase SGST:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtReturnPurchaseSGST" runat="Server" CssClass="txt" TabIndex="36" Height="24px"
                                    Width="80px" Style="text-align: right;" OnkeyDown="ReturnPurchaseSGST(event);" AutoPostBack="false" OnTextChanged="txtReturnPurchaseSGST_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right" style="width: 20%;">Return Purchase IGST:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtReturnPurchaseIGST" runat="Server" CssClass="txt" TabIndex="37" Height="24px"
                                    Width="80px" Style="text-align: right;" OnkeyDown="ReturnPurchaseIGST(event);" AutoPostBack="false" OnTextChanged="txtReturnPurchaseIGST_TextChanged"></asp:TextBox>
                        ...
                        <td> TCS/TDS  Balance Limit 
                           <asp:TextBox ID="txtBalancelimit" runat="Server" CssClass="txt" TabIndex="37" Height="24px"
                                Width="150px" Style="text-align: right;" AutoPostBack="false"></asp:TextBox>

                          </td>
                    </tr>
                    <tr>
                        <td align="right" style="width: 20%;">Sale TDS Ac:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtSaletdsAc" runat="Server" CssClass="txt" TabIndex="37" Height="24px"
                            ...
                            <asp:TextBox ID="txtsaletdsrate" runat="Server" CssClass="txt" TabIndex="37" Height="24px"
                        ...
                        <td align="right" style="width: 20%;">Purchase TDS Ac:
                        </td>
                        <td align="left" style="width: 30%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <asp:TextBox ID="txtPurchasetdsrate" runat="Server" CssClass="txt" TabIndex="37" Height="24px"
                                Width="50px" Style="text-align: right;" AutoPostBack="false"></asp:TextBox>
