...
public partial class Sugar_Master_pgeWhatsAppURL : System.Web.UI.Page
{
    ...
    string OtpEmailTo = string.Empty;
    #endregion
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (isAuthenticate == "1" || User_Type == "A")
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        txttoEmail.Text = ds.Tables[0].Rows[0]["OtpEmailTo"].ToString();
                    }
           ...
           if (s == null || s == string.Empty || s == "0")
            {
                ...
                Head_Fields = Head_Fields + "OtpEmailTo";
                Head_Values = Head_Values + "'" + OtpEmailTo + "'";
                flag = 1;
            ...
            else
            {
                ...
                if (s1 != string.Empty)
                {
                    ...
                    Head_Update = Head_Update + "'" + Mobile_No + "',";
                    Head_Update = Head_Update + "OtpEmailTo=";
                    Head_Update = Head_Update + "'" + OtpEmailTo + "'";
                    #endregion
                }
                flag = 2;
