    ...
    <script type="text/javascript">
        function validation() {
            ...
            XML = XML + "<SystemHead System_Type='" + System_Type + "' System_Code='" + systemcode + "' System_Name_E='" + System_Name_E + "' System_Name_R='' " +
                ...
                "KgPerKatta='" + KgPerKatta + "' Company_Code='" + Company_Code + "' Year_Code='" + Year_Code + "' Branch_Code='0' " + insertrecord + " " +
                    ...
                    <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                        ...
                        <table style="width: 80%;" align="left" cellpadding="3" cellspacing="5">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtgst_Code" runat="server" CssClass="txt" Width="80px" onkeydown="gstcode(event);" AutoPostBack="false"
                                        OnTextChanged="txtgst_Code_TextChanged" TabIndex="11" Height="24px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 50%;">
                                    <asp:DropDownList ID="drpMarketSet" runat="server" CssClass="ddl" Width="180px" TabIndex="12"
                                        Height="25px">
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 50%;">
                                    <asp:DropDownList ID="drpsupercost" runat="server" CssClass="ddl" Width="180px" TabIndex="13"
                                        Height="25px">
