...
public partial class Sugar_Master_pgeAccountUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, string Trantype, int PageSize, int Company_Code)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "(Ac_Code like '%" + aa + "%' or Ac_type like '%" + aa + "%' or Ac_Name_E like '%" + aa + "%'or Short_Name like '%" + aa + "%' or Commission like '%" + aa + "%' or Address_E like '%" + aa + "%' or cityname like '%" + aa + "%' or citygststatecode like '%" + aa + "%' or Gst_No like '%" + aa + "%' or AC_Pan like '%" + aa + "%' or FSSAI like '%" + aa + "%' or adhar_no like '%" + aa + "%' or Mobile_No like '%" + aa + "%' or accoid like '%" + aa + "%') and";
