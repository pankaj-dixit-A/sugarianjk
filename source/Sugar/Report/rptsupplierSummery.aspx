<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptsupplierSummery.aspx.cs" Inherits="Sugar_Report_rptsupplierSummery" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CrysupplierSummery" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
