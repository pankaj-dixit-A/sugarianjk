...
public partial class Sugar_Report_rptPartybrokercashdiff : System.Web.UI.Page
{
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                cmd = new SqlCommand("select * from qrytenderheaddetail where  Buyer_Party >2 and Buyer_Party= '" + Accode + "' and CashDifference!='0' and  Company_Code=" + company_code + " and Year_Code=" + year_code + " and Tender_Date between '" + fromdt + "' and '" + todt + "'", con);
            }
