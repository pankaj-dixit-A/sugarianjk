...
public partial class Report_rptStoreProcedureBalanceSheet : System.Web.UI.Page
{
    ...
    string CwhereDate = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CwhereDate = Request.QueryString["Cwhere"];
        CwhereDate = DateTime.Parse(CwhereDate, System.Globalization.CultureInfo.CreateSpecificCulture("en-GB")).ToString("dd/MM/yyyy");
        lbldate.Text = "Balance Sheet Up To " + CwhereDate + "";
    ...
    private void bindData()
    {
        try
        {
            ...
            string Cwhere = DateTime.Parse(CwhereDate, System.Globalization.CultureInfo.CreateSpecificCulture("en-GB")).ToString("yyyy/MM/dd");
