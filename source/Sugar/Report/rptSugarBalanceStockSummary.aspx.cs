...
public partial class Sugar_Report_rptSugarBalanceStockSummary : System.Web.UI.Page
{
    ...
    private DataTable GetData()
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (Accode != "0")
            {
                cmd = new SqlCommand("select * from qryDayPatrakReport where Company_Code=" + company_code + " and Year_Code=" + year_code + " and self<> 0 or UnLiftedQntl <> 0  order by Lifting_Date", con);
