...
public partial class Sugar_Report_pgeSaleBill_PrintEthanole : System.Web.UI.Page
{
    ...
    string partycityname = string.Empty;
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            rpt.Load(Server.MapPath("crySaleBill_PrintEthanole.rpt"));
            ...
            crySaleBill_PrintEthanole.ReportSource = rpt;
            ...
            crySaleBill_PrintEthanole.RefreshReport();
        }
        catch (Exception)
        {
    ...
    private DataTable GetData()
    {
        try
        {
            ...
            partycityname = dt.Rows[0]["billtopin"].ToString();
    ...
    protected void btnWhatsApp_Click(object sender, EventArgs e)
    {
        ...
        //}
        //string uploadedFileName = "salebill.pdf";
        ...
        //ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "api-call", "javascript:sendPdfToWatsapp('" + base64String + "', '" + uploadedFileName + "','Salebill from new updated whatsapp api','" + mobileNumber + "', 'LATASOFTWARE');", true);
        #endregion
        ...
        string uploadedFileName = "SB.pdf";
        string pdfname = filepath + "\\" + uploadedFileName;
        rpt.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, pdfname);
        var fileBytes = File.ReadAllBytes(pdfname);
        var base64String = System.Convert.ToBase64String(fileBytes);

        string message = "No:" + doc_no + "Mill:" + millname + "  TruckNo:" + lorryno + " Qty:" + netqntl + " PartyName:" + partyname + ",Cityname:" + partycityname + ".pdf";
        ...
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "api-call", "javascript:sendPdfToWatsapp('" + base64String + "', '" + uploadedFileName + "','" + instanceid + "','" + accesstoken + "','DO from new updated whatsapp api','" + mobileNumber + "', 'LATASOFTWARE');", true);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.crySaleBill_PrintEthanole.ReportSource = null;

        crySaleBill_PrintEthanole.Dispose();
