    ...
    private void BindData()
    {
        try
        {
            using (clsDataProvider obj = new clsDataProvider())
            {
                ...
                if (Chargetype == "G")
                {
                    lblDate.Text = "From :" + FromDt + " To: " + ToDt;
                    ...
                    ac_code = "Select Ac_Code from qrymstaccountmaster where Group_Code='" + GroupCode
                ...
                else
                {
                    ...
                    ac_code = "Select Ac_Code from qrymstaccountmaster where Ac_type='" + Chargetype + "' and Company_Code="
