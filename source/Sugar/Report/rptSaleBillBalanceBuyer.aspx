<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSaleBillBalanceBuyer.aspx.cs" Inherits="Sugar_Report_rptSaleBillBalanceBuyer" %>
...
<body>
     <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="CrySaleBillBalanceBuyer" runat="server" AutoDataBind="true" bestfitpage="False" width="1500px" />
