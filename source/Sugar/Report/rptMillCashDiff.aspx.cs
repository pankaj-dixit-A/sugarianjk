...
public partial class Sugar_Report_rptMillCashDiff : System.Web.UI.Page
{
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                cmd = new SqlCommand("select * from qrytenderhead where Broker= '" + Accode + "' and CashDiff!='0' and  Company_Code=" + company_code + " and Year_Code=" + year_code + " and Tender_Date between '" + fromdt + "' and '" + todt + "' order by Tender_No", con);
            }
