...
public partial class Sugar_Report_rptperformainvoice_Print : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            rpt.Load(Server.MapPath("cryPerformaInvoicenew.rpt"));
            rpt.SetDataSource(dt);

            string docno = doc_no;
            docno = docno.PadLeft(6, '0');

            cryPerformaInvoicenew.ReportSource = rpt;
            ...
            cryPerformaInvoicenew.RefreshReport();
        }
        catch (Exception)
        {
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryPerformaInvoicenew.ReportSource = null;

        cryPerformaInvoicenew.Dispose();
