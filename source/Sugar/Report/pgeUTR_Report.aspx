...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function AgaintBuyer(accode, FromDt, ToDt) {
            var tn;
            window.open('rptSaleBillBalanceBuyer.aspx?Ac_Code=' + accode + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
        }
        function AgaintSupplier(accode, FromDt, ToDt) {
            var tn;
            window.open('rptsupplierSummery.aspx?Ac_Code=' + accode + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <center>
        ...
        <table>
            ...
            <tr>
                <td align="left" style="width: 40%;">
                    <asp:Button ID="btnRetailBillSummary" runat="server" Text="Retail Bill Summery" CssClass="btnHelp"
                        Width="170px" Height="24px" TabIndex="6" OnClick="btnRetailBillSummary_Click" />
                </td>

                <td align="right" style="width: 50%;"> 
                 <asp:Button ID="btnsupplierSummery" runat="server" Text="Supplier Summery" CssClass="btnHelp"
                        Width="170px" Height="24px" TabIndex="6" OnClick="btnsupplierSummery_Click" />
                 </td>
            </tr>
            
            <tr>
                <td align="left" style="width: 40%;">
                     <asp:Button ID="btnTopBuyer" runat="server" Text="Customer Summery" CssClass="btnHelp"
                        Width="170px" Height="24px" TabIndex="6" OnClick="btnTopBuyer_Click" />
                      </td>
