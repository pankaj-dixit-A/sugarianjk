...
public partial class Sugar_Report_rptSaleBillBalanceBuyer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                datefrom = DateTime.Parse(fromdt, System.Globalization.CultureInfo.CreateSpecificCulture("en-GB")).ToString("dd-MM-yyyy");
                dateto = DateTime.Parse(todt, System.Globalization.CultureInfo.CreateSpecificCulture("en-GB")).ToString("dd-MM-yyyy");

                pagehead = "Customerwise Quantal And Bill Amount Report  from " + datefrom + " To " + dateto;
                ...
                rprt1.Load(Server.MapPath("CrySaleBillBalanceBuyer.rpt"));
                rprt1.SetDataSource(dt);
                CrySaleBillBalanceBuyer.ReportSource = rprt1;
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrySaleBillBalanceBuyer.ReportSource = null;

        CrySaleBillBalanceBuyer.Dispose();
