...
public partial class Sugar_pgeCreateReturnFilesNew : System.Web.UI.Page
{
    ...
    protected void btnOtherPur_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string qry = "select ROW_NUMBER() OVER(ORDER BY (SELECT 1)) AS SR_No,s.Doc_No as Invoice_No,s.Gst_No as PartyGSTNo,Supplier_Code as PartyCode," +
             "s.suppilername as PartyName,s.GSTStateCode as PartyStateCode,CONVERT(varchar(10),s.doc_date,103) as Invoice_Date,s.Taxable_Amount as TaxableAmount,s.CGST_Amount as CGST,s.SGST_Amount as SGST,s.IGST_Amount as IGST,s.Bill_Amount,s.billno AS BillNo,s.TDS_Amt as TDSAmount,s.Narration as Narration from qryotherpurchase s " +
    ...
    protected void btnhsnsale_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string qry = "select HSN,sum(BillAmt) as BillAmt,sum(CgstAmt) as CgstAmt,sum(SgstAmt) as SgstAmt,sum(IgstAmt) as IgstAmt,sum(TCSAmt) as TCSAmt,sum(NetPayable) as NetPayable from qryHSNSale where doc_date between '" 
                + fromdt + "' and '" + todt + "' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString())
            ...
            if (ds != null)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    grdAll.FooterRow.Cells[6].Text = totalInv_Value.ToString();
                    grdAll.FooterRow.Cells[5].Text = totaltcsamt.ToString();

                    grdAll.FooterRow.Cells[1].Text = totalTaxable_Value.ToString();
                    grdAll.FooterRow.Cells[4].Text = totalIGST_Amount.ToString();
                    grdAll.FooterRow.Cells[2].Text = totalCGST_Amount.ToString();
                    grdAll.FooterRow.Cells[3].Text = totalSGST_Amount.ToString();
                ...
                if (hdconfirm.Value == "Yes")
                {
                    ...
                    string strForCSV = "";
                    DataView dvWrongGst = new DataView(dt);
                    dvWrongGst.RowFilter = " NOT(ISNULL(HSN, '') = '') ";
                    ...
                    if (lblSummary.Text == "PS TCS TDS Summary")
                    {
                        if (chkpermissionGST.Checked == true)
                        {
                            ...
                            GSTbody = "To our Esteemed  business associates ,<br /> As per the new GST guidelines we may get INPUT TAX CREDIT (ITC)  " +
                                           ...
                                           "<table><tr><td>GST NO</td><td>Pan No</td><td>TAN NO</td><td>Name of Party</td><td>Taxable Amt</td><td>CGST Amt</td><td>SGST Amt</td><td>IGST Amt</td><td>Bill Amount</td></tr>" +
                                           "<tr><td>" + grdDetail_Report.Rows[i].Cells[4].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[5].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[6].Text.ToString() + "</td>" +
                        ...
                        if (checkTDS.Checked == true)
                        {
                            TDSbody = "Respected business associates<br /> We have deducted TDS  against our purchases  to you as below.Please reconcile and let us know if any differences arise. <br /><br />" +
                                      "<table><tr><td>Party Name</td><td>GST NO</td><td>PAN NO</td><td>TAN NO</td><td>TAXABLE VALUE</td><td>TDS DEDUCTED</td><td>TOTAL SALE VALUE</td>" +
                                           "</tr><tr><td>" + grdDetail_Report.Rows[i].Cells[3].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[4].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[5].Text.ToString() + "</td>" +
                        ...
                        if (chkpermissionTCS.Checked == true)
                        {
                            ...
                            TCSbody = "Respected business associates<br />  We have claimed TCS  against our purchases  to you as below.Please reconcile and let us know if any differences arise.  <br /><br />" +
                                      "<table><tr><td>Party Name</td><td>GST NO</td><td>PAN NO</td><td>TAN NO</td><td>TAXABLE VALUE</td><td>TCS DEDUCTED</td><td>TOTAL SALE VALUE</td>" +
                                           "</tr><tr><td>" + grdDetail_Report.Rows[i].Cells[3].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[4].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[5].Text.ToString() + "</td>" +
                    ...
                    else
                    {
                        if (chkpermissionGST.Checked == true)
                        {
                            ...
                            GSTbody = "Respected business associates,<br /> We have generated Tax invoices on you for the above mentioned period as per the following data . Please reconcile and let us know if any differences arise<br /><br />" +
                                           "<table><tr><td>Party Name</td><td>GST NO</td><td>PAN NO</td><td>TAN No</td><td>TAXABLE VALUE</td><td>CGST Amt</td><td>SGST Amt</td><td>IGST Amt</td><td>TOTAL SALE VALUE </td></tr>" +
                                           "<tr><td>" + grdDetail_Report.Rows[i].Cells[3].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[4].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[5].Text.ToString() + "</td>" +
                        ...
                        if (checkTDS.Checked == true)
                        {
                            TDSbody = "Respected business associates<br /> We have claimed the monthly TDS against our sales to you as below.Please reconcile and let us know if any differences arise.<br /><br />" +
                                      "<table><tr><td>Party Name</td><td>GST NO</td><td>PAN NO</td><td>TAN No</td><td>TAXABLE VALUE</td><td>TDS TO BE CLAIMED</td><td>TOTAL SALE VALUE</td>" +
                                           "</tr><tr><td>" + grdDetail_Report.Rows[i].Cells[3].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[4].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[5].Text.ToString() + "</td>" +
                                           "<td>" + grdDetail_Report.Rows[i].Cells[6].Text.ToString() + "</td><td align=right>" + grdDetail_Report.Rows[i].Cells[7].Text.ToString() + "</td><td align=right>" + grdDetail_Report.Rows[i].Cells[12].Text.ToString() + "</td><td align=right>" + grdDetail_Report.Rows[i].Cells[13].Text.ToString() + "</td></tr></table>";
                        ...
                        if (chkpermissionTCS.Checked == true)
                        {
                            ...
                            TCSbody = "Respected business associates<br />  We have collected  the monthly TCS against our sales to you as below.Please reconcile and let us know if any differences arise.<br /><br />" +
                                      "<table><tr><td>Party Name</td><td>GST NO</td><td>PAN NO</td><td>TAN NO</td><td>TAXABLE VALUE</td><td>TCS COLLECTED</td><td>TOTAL SALE VALUE</td>" +
                                           "</tr><tr><td>" + grdDetail_Report.Rows[i].Cells[3].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[4].Text.ToString() + "</td><td>" + grdDetail_Report.Rows[i].Cells[5].Text.ToString() + "</td>" +
                                           "<td>" + grdDetail_Report.Rows[i].Cells[6].Text.ToString() + "</td><td align=right>" + grdDetail_Report.Rows[i].Cells[7].Text.ToString() + "</td><td align=right>" + grdDetail_Report.Rows[i].Cells[11].Text.ToString() + "</td><td align=right>" + grdDetail_Report.Rows[i].Cells[13].Text.ToString() + "</td></tr></table>";
    ...
    protected void grdDetail_Report_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            e.Row.Cells[1].ControlStyle.Width = Unit.Percentage(15);
            ...
            e.Row.Cells[13].ControlStyle.Width = Unit.Percentage(15);
