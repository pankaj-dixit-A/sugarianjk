...
public partial class Reports_rptLedger : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            txtWhatsapp.Text = clsCommon.getString("select whatsup_no from " + AccountMasterTable + "  where  Ac_Code=" + accode + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
        ...
        try
        {
            using (clsDataProvider obj = new clsDataProvider())
            {
                ...
                qry = " select TRAN_TYPE,DOC_NO,DOC_DATEConverted as DOC_DATE1,NARRATION,AMOUNT,ADJUSTED_AMOUNT,Ac_Code,UNIT_Code,DRCR,SORT_TYPE,SORT_NO,'' as DO_NO " +
                    " from qrygledger  where AC_CODE=" + accode + " and DOC_DATE between '" + fromdt + "' and '" + todt + "' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " order by DOC_DATE ,drcr  ,DOC_NO asc ,ORDER_CODE";
                ds = clsDAL.SimpleQuery(qry);
                //qry = "select TRAN_TYPE,DOC_NO,Convert(varchar(10),DOC_DATE,102) as DOC_DATE ,NARRATION,AMOUNT,ADJUSTED_AMOUNT,AC_CODE,UNIT_Code,DRCR,SORT_TYPE,SORT_NO,'' as DO_NO from " + tblGLEDGER +
                //        " where AC_CODE=" + accode + " and DOC_DATE between '" + fromdt + "' and '" + todt + "' and  Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " order by DOC_DATE asc,SORT_TYPE,SORT_NO,ORDER_CODE ";
                //ds = clsDAL.SimpleQuery(qry);
    ...
    protected void btnWhatsApp_Click(object sender, EventArgs e)
    {
        ...
        string uploadedFileName = "Ledger_" + lblAcCode.Text + ".pdf";
        string filepath = "~/PAN/" + uploadedFileName;
        ...
        ContentType contentType = new ContentType();
        contentType.MediaType = MediaTypeNames.Application.Pdf;
        contentType.Name = uploadedFileName;
        ...
        //https://wawatext.com/api/send.php?number=918806091854&type=text&message=hiii&instance_id=629C42938BD38&access_token=6c596a733f89149b69a1c334f12f65b1
       // string Url = "https://wawatext.com/api/send.php?number=91" + mobileNumber + "&type=text&message=" + uploadedFileName + "&instance_id=62A08B1183599&access_token=6c596a733f89149b69a1c334f12f65b1";
        string Url = "https://wawatext.com/api/send.php?number=91" + mobileNumber + "&type=text&message=" + uploadedFileName + "&instance_id=" + instanceid + "&access_token=" + accesstoken + "";
        ...
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "api-call", "javascript:sendPdfToWatsapp('" + base64String + "', '" + uploadedFileName + "','" + instanceid + "','" + accesstoken + "','Salebill from new updated whatsapp api','" + mobileNumber + "', 'LATASOFTWARE');", true);
