            ...
            <asp:Panel runat="server" ID="pnlSale" BorderColor="Blue" Style="margin: 0 auto;"
                ...
                <asp:GridView ID="grdDetail_Report" runat="server" AutoGenerateColumns="false" HeaderStyle-BackColor="#397CBB"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField ControlStyle-Width="500px" DataField="fromDate" HeaderText="fromDate" />
                                                ...
                                                <asp:BoundField ControlStyle-Width="10px" DataField="Taxable_Amt" HeaderText="Taxable_Amt" />
                                                <asp:BoundField ControlStyle-Width="10px" DataField="CGST" HeaderText="CGST" />
                                                <asp:BoundField ControlStyle-Width="10px" DataField="SGST" HeaderText="SGST" />
                                                <asp:BoundField ControlStyle-Width="10px" DataField="IGST" HeaderText="IGST" />
                                                <asp:BoundField ControlStyle-Width="10px" DataField="TCS" HeaderText="TCS" />
                                                <asp:BoundField ControlStyle-Width="10px" DataField="TDS" HeaderText="TDS" />
                                                <asp:BoundField ControlStyle-Width="10px" DataField="Bill_Amt" HeaderText="Bill_Amt" />
