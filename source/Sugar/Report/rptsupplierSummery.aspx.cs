...
public partial class Sugar_Report_rptsupplierSummery : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Supplierwise Quantal And Bill Amount Report From " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CrysupplierSummery.rpt"));
                rprt1.SetDataSource(dt);
                CrysupplierSummery.ReportSource = rprt1;
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrysupplierSummery.ReportSource = null;

        CrysupplierSummery.Dispose();
