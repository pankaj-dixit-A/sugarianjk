...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        function Validate() {
            ...
            Post_Date = Post_Date.slice(6, 11) + "/" + Post_Date.slice(3, 5) + "/" + Post_Date.slice(0, 2);

            if (DocDates < Post_Date) {
        ...
        <ContentTemplate>
                ...
                <table width="80%" align="left">
                    <tr>
                        ...
                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btnHelp" Width="90px"
                            TabIndex="27" ValidationGroup="add" OnClick="btnDelete_Click" OnClientClick="Confirm()" Height="24px" />
                            &nbsp;
                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btnHelp" Width="90px"
                            TabIndex="28" Height="24px" ValidationGroup="save" OnClick="btnCancel_Click" />
                            &nbsp;
                        <asp:Button ID="btnBack" runat="server" Text="Back" CssClass="btnHelp" Width="90px"
                            TabIndex="29" Height="24px" ValidationGroup="save" OnClientClick="Back()" />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtEditDoc_No" CssClass="txt" Width="100px" Height="24px"
                                TabIndex="2" AutoPostBack="true" OnTextChanged="txtEditDoc_No_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="5">
                            <asp:TextBox ID="txtCashBank" runat="server" CssClass="txt" Style="text-align: right;"
                                onkeydown="cashbank(event);" AutoPostBack="false" TabIndex="5" OnTextChanged="txtCashBank_TextChanged" Height="24px"></asp:TextBox>
                ...
                <table width="90%" align="center">
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="4">
                            <asp:TextBox ID="txtUnit_Code" runat="Server" CssClass="txt" TabIndex="7" Width="80px"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="drpFilter" runat="server" CssClass="ddl" Width="280px" Height="25px"
                                Visible="true" AutoPostBack="true" TabIndex="8" OnSelectedIndexChanged="drpFilter_SelectedIndexChanged"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtVoucherNo" Height="24px" runat="Server" CssClass="txt" Width="80px" Enabled="false"
                                onkeydown="voucherno(event);" Style="text-align: right;" TabIndex="9" AutoPostBack="false" OnTextChanged="txtVoucherNo_TextChanged"></asp:TextBox>
                            <asp:Button ID="btntxtVoucherNo" runat="server" Text="..." OnClick="btntxtVoucherNo_Click"
                                TabIndex="10" CssClass="btnHelp" Height="24px" Width="20px" />
                            ...
                            <asp:Button ID="btnsoudaall" runat="server" Text="..." OnClick="btnsoudaall_Click"
                                TabIndex="11" CssClass="btnHelp" Height="24px" Width="20px" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtamount" runat="Server" TabIndex="12" Height="24px" CssClass="txt"
                            ...
                            <asp:TextBox ID="txtadAmount" runat="Server" CssClass="txt" Height="24px" Width="80px"
                                Style="text-align: right;" AutoPostBack="false" TabIndex="13" OnTextChanged="txtadAmount_TextChanged"></asp:TextBox>
                            ...
                            <asp:TextBox ID="txtacadjamt" Height="24px" runat="Server" CssClass="txt" Width="80px"
                                Style="text-align: right;" TabIndex="14"></asp:TextBox>
                            Adjusted AC Code:
                        
                            <asp:TextBox ID="txtacadjAccode" runat="Server" CssClass="txt" Width="80px" Style="text-align: right;"
                                onkeydown="acadjaccode(event);" TabIndex="15" AutoPostBack="false" OnTextChanged="txtacadjAccode_TextChanged" Height="24px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtTDSRate" runat="Server" TabIndex="16" Height="24px" CssClass="txt"
                            ...
                            <asp:TextBox ID="txtTDSAmt" runat="Server" CssClass="txt" Height="24px" Width="80px"
                                Style="text-align: right;" AutoPostBack="false" TabIndex="17" OnTextChanged="txtTDSAmt_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtnarration" runat="Server" CssClass="txt" Width="480px" Height="50px"
                                onkeydown="narration(event);" TextMode="MultiLine" Style="text-align: left;" AutoPostBack="True" TabIndex="18"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtNarration2" runat="Server" CssClass="txt" Width="480px" Height="24px"
                                Style="text-align: left;" AutoPostBack="True" TabIndex="19" OnTextChanged="txtNarration2_TextChanged"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">GRN
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtGRN" runat="Server" CssClass="txt" Width="480px" Height="24px"
                                Style="text-align: left;" TabIndex="20"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtTReceipt" runat="Server" CssClass="txt" Width="480px" Height="24px"
                                Style="text-align: left;" TabIndex="21" ></asp:TextBox>
                    ...
                    <tr>
                        <td colspan="2" align="left">
                            <asp:Button ID="btnAdddetails" runat="server" Text="ADD" CssClass="btnHelp" Width="80px"
                                Height="24px" OnClick="btnAdddetails_Click" TabIndex="22" />
                            <asp:Button ID="btnClosedetails" runat="server" Text="Close" CssClass="btnHelp"
                                Height="24px" Width="80px" OnClick="btnClosedetails_Click" TabIndex="23" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
            <div style="width: 100%; position: relative;">
                <asp:UpdatePanel ID="upGrid" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="pnlgrdDetail" runat="server" ScrollBars="Both" Height="250px" Width="2000px"
                            ...
                            <asp:GridView ID="grdDetail" runat="server" AutoGenerateColumns="true" HeaderStyle-BackColor="#397CBB"
                                HeaderStyle-ForeColor="White" HeaderStyle-Height="30px" GridLines="Both" Width="200%"
