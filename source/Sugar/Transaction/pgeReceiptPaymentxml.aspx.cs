...
public partial class Sugar_pgeReceiptPaymentxml : System.Web.UI.Page
{
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            string max = clsCommon.getString("select isnull(max(tranid),0) as id from " + tblHead + " where tran_type='" + drpTrnType.SelectedValue + "' ");
            hdnfTran_type.Value = drpTrnType.SelectedValue;
            hdnf.Value = max;
        }
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        qry = "select detail_id as ID,credit_ac as AcCode,creditname as Name,Unit_Code,unitname as Unit_Name,Voucher_No,Voucher_Type,Tender_No as TenderNo," +
                            " tenderdetailid as DetailID, amount as Amount,Adjusted_Amount,narration,narration2,drpFilterValue,isnull(YearCodeDetail,0) as YearCodeDetail,trandetailid,''as rowAction,'' as SrNo,ca as ac,uc,AcadjAmt,AcadjAccode,AcadjAcname,ad,TDS_Rate as TDSRate,TDS_Amt as TDSAmt,GRN,TReceipt" +
" from " + qryDetail + " where tranid=" + hdnf.Value + " and Tran_Type='" + hdnfTran_type.Value + "'";
    ...
    protected void grdDetail_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        try
        {
            ...
            e.Row.Cells[Grid_Name].ControlStyle.Width = Unit.Percentage(80);
            e.Row.Cells[Grid_Unit_Code].ControlStyle.Width = Unit.Percentage(20);
            e.Row.Cells[Grid_Unit_Name].ControlStyle.Width = Unit.Percentage(80);
            ...
            e.Row.Cells[Grid_amount].ControlStyle.Width = Unit.Percentage(50);
            e.Row.Cells[Grid_Adjusted_Amount].ControlStyle.Width = Unit.Percentage(40);
            e.Row.Cells[Grid_narration].ControlStyle.Width = Unit.Percentage(50);
            e.Row.Cells[Grid_narration2].ControlStyle.Width = Unit.Percentage(25);
            e.Row.Cells[Grid_drpFilterValue].ControlStyle.Width = Unit.Percentage(20);
            e.Row.Cells[Grid_YearCodeDetail].ControlStyle.Width = Unit.Percentage(10);
            e.Row.Cells[_Grid_trandetailid].ControlStyle.Width = Unit.Percentage(10);
            ...
            e.Row.Cells[22].ControlStyle.Width = Unit.Percentage(50);
            ...
            e.Row.Cells[28].ControlStyle.Width = Unit.Percentage(30);
            e.Row.Cells[29].ControlStyle.Width = Unit.Percentage(30);
        ...
        try
        {
            ...
            if (strTextBox == "txtVoucherNo")
            {
                ...
                if (drpFilter.SelectedValue == "B" || drpFilter.SelectedValue == "Y")
                {
                  ...
                  " Year_Code as EntryYearCode,millshortname from qrysalebillbalance where Ac_Code='" + txtACCode.Text + "' and balance!=0 AND Company_Code='" + Session["Company_Code"].ToString() + "' and Year_Code='" + Session["year"].ToString() + "'";
