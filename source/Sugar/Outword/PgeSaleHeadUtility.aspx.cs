...
public partial class Sugar_Master_PgeSaleHeadUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
       ...
       + "billtoname ,billtogstno,shiptoname,NETQNTL,Bill_Amount,millname,EWay_Bill_No,ackno,saleid,IsDeleted FROM qrysalehead   where " + name + " and Company_Code=" + Company_Code + " " +
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
       ...
       + "billtoname ,billtogstno,shiptoname,NETQNTL,Bill_Amount,millname,EWay_Bill_No,ackno,saleid,IsDeleted FROM " + qryCommon + " limit 15";
