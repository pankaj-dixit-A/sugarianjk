...
public partial class Sugar_Master_PgeShugarSalerUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
       ...
       + "Ac_Name_E ,NETQNTL,Bill_Amount,srid,ackno,Eway_Bill_No FROM qrysugarsalereturnhead    where " + name + " and Company_Code=" + Company_Code + " " +
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
       ...
       + "Ac_Name_E ,NETQNTL,Bill_Amount,srid,ackno,Eway_Bill_No FROM " + qryCommon + " limit 15";
