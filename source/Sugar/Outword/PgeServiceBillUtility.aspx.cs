...
public partial class Sugar_Master_PgeServiceBillUtility : System.Web.UI.Page
{
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
       ...
       + "Customer_Code ,Ac_Name_E,gstrate,Item_Code,Subtotal,Final_Amount,TDS_Per,ackno,rbid FROM qryrentbillheaddetail   where " + name + " and Company_Code=" + Company_Code + " " +
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
      ...
      + "Customer_Code ,Ac_Name_E,gstrate,Item_Code,Subtotal,Final_Amount,TDS_Per,ackno,rbid FROM " + qryCommon + " limit 15";
