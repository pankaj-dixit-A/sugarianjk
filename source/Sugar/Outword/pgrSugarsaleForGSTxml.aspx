...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function SBEhanole(saleid, billto, docnumber, corporatenumber, corporate) {
            window.open('../Report/pgeSaleBill_PrintEthanole.aspx?doc_no=' + saleid + '&billto=' + billto + '&docnumber=' + docnumber
                + '&corporatenumber=' + corporatenumber + '&corporate=' + corporate);

        }
        function SB(saleid, billto, docnumber, corporatenumber, corporate, Type) {
            window.open('../Report/pgeSaleBill_Print.aspx?doc_no=' + saleid + '&billto=' + billto + '&docnumber=' + docnumber
                + '&corporatenumber=' + corporatenumber + '&corporate=' + corporate + '&Type=' + Type);

        } 
        function SB1(saleid, billto, docnumber, corporatenumber, corporate, Type) {
    ...
    <script type="text/javascript" language="javascript">
        ...
        function pagevalidation() {
            ...
            try {
                ...
                var Unit = $("#<%=drpUnit.ClientID %>").val() == "" ? 0 : $("#<%=drpUnit.ClientID %>").val(); 
                ...
                XML = XML + "<SaleHead " + DOCNO + " doc_date='" + doc_date + "' Ac_Code ='" + Ac_Code + "' Unit_Code='" + Unit_Code + "' mill_code='" + mill_code + "' " +
                   ...
                   "' IsDeleted='1' TDS_Rate='" + TDS_Rate + "' TDS_Amt='" + TDS_Amt + "' SBNarration='" + SBNARRATION + "' Unit='" + Unit + "'>";
                var gridView = document.getElementById("<%=grdDetail.ClientID %>");
                var grdrow = gridView.getElementsByTagName("tr");
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <asp:Button runat="server" ID="btnPrintSaleBill" Text="Print" CssClass="btnHelp"
                              ...
                              <asp:Button runat="server" ID="btnTurmeric" Text="Turmeric Print" CssClass="btnHelp"
                                OnClick="btnTurmeric_Click" Width="100px" Height="24px"  OnClientClick="Confirm1()"/>
                              <asp:Button runat="server" ID="Button1" Text="Ethanol Print" CssClass="btnHelp"
                                OnClick="btnSaleBillPrint_Click" Width="100px" Height="24px" OnClientClick="Confirm1()" />
                            &nbsp;&nbsp;
