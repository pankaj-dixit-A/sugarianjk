            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        Session["P_Date"] = clsCommon.getString("select Convert(varchar(10),Post_Date,103)as Post_Date from Post_Date where Company_Code=" + companyCode);
                        ...
                        if (ds != null)
                        {
                            if (ds.Tables.Count > 0)
                            {
                                ...
                                if (dt.Rows.Count > 0)
                                {
                                    ...
                                    Session["OtpEmailTo"] = dt.Rows[0]["OtpEmailTo"].ToString();
